...
import static genshin.Element.*;
import static genshin.Weapon.*;
import static genshin.Nation.*;
...
public enum Char {
    ...
    final genshin.Element element;
    final genshin.Nation nation;
    final genshin.Weapon weapon;
    ...
    Char (String name, double version, genshin.Element element, genshin.Nation nation, genshin.Weapon weapon){
